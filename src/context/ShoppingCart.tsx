  ...
  return (
    ...
    >
      <dialog
        ...
        className="modal cursor-pointer max-[768px]:modal-bottom"
      >
        <div className="modal-box relative min-h-fit px-0 py-0">
          <div className="card-header mt-3 flex gap-2">
            <div className="stack">
              {cart.items.map((item) => (
                <Image
                  key={item.productId}
          ...
          {cart.items?.length === 0 ? (
            ...
            <table className="flex max-h-[50vh] w-full items-center justify-center overflow-scroll bg-base-100">
              <thead>
                <tr>
                  <th className="max-w-[120px]">Producto</th>
                  <th className="max-w-[120px]">Precio</th>
                  <th className="max-w-[120px]">Cantidad</th>
                  <th className="w-4"></th>
                </tr>
              </thead>
              <tbody>
